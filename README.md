...
| :--- | :--- | --- | :---: | :---: |
| [Nimbler](https://nimbler.app/) | Data Scientist | Организация сбора и разметки данных на платформе toloka.ai для приложения контроля трат. Разработка моделей категоризации и кластеризации трат. | 08.2022 | Н.В. |
