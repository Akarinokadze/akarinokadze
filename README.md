...
| :--- | --- | :--- | :---: |
| [Мастерская BigData PySpark Chicago taxi dispatch](https://github.com/Akarinokadze/workshop_pyspark_taxi) | Мастерская по обработке больших данных. Предсказание порайонного количества заказов такси с помощью вычислительного кластера Spark развёрнутого в Docker-контейнерах. <br/> - развернул Hadoop кластер на локальной машине в docker-контейнерах; <br/> - провёл EDA средствами PySpark; <br/> - провёл feature-engineering для time-series данных; <br/> - с помощью MLlib провёл обучение нескольких моделей машинного обучения и предсказал количество заказов на следующий час для каждого района Чикаго. | JupyterLab, PySpark, MLlib, Docker, Python - *os, pandas, numpy, matplotlib, seaborn, statsmodels, tqdm* | Завершена |
